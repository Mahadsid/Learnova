...
// EMPTY STATE OR INITIAL STATE OR WHEN DRAG N DROP IS NOT DOING ANYTHING
export function RenderEmptyState({ isDragActive }: { isDragActive: boolean }) {
    return (
        <div className="text-center">
            ...
            <p className="text-base font-semibold text-foreground">Drop your files here or <span className="text-primary font-bold cursor-pointer">Browse to upload</span>
            </p>
            <Button className="mt-4" type="button">Upload File</Button>
        </div>
    )
}
