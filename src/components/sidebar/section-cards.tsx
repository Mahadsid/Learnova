import { IconBook, IconShoppingCart, IconUsers, IconVideo } from "@tabler/icons-react"
...
import { adminGetDashboardStats } from "@/app/dataAcclyr/admin/admin-get-dashboard-stats"
  ...
  return (
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4  *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <p className="text-muted-foreground">Available lessons for learning</p>
        </CardFooter>
      </Card>
    </div>
  )
