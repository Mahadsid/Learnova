...
export function CourseSidebar({ course }: iAppProps) {
    ...
    //pop() gives us the last item so in url the last item is our lessonId of which video is playing.
                    ...
                    <Collapsible key={chapter.id} defaultOpen={ index === 0 }>
                        ...
                        <CollapsibleContent className="mt-3 pl-6 border-l-2 space-y-3">
                            {chapter.lessons.map((lesson) => (
                                <LessonItem lesson={lesson} key={lesson.id} slug={course.slug} isActive={currentLessonId === lesson.id} completed={lesson.lessonProgress.find(
