...
export default async function SlugPage({ params }: { params: Params }) { 
    // since it is a promise so we awaited it and get our slug from URL
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 mt-5">
            <div className="order-1 lg:col-span-2">
                ...
                <div className="relative aspect-video w-full overflow-hidden rounded-xl shadow-lg">
                    <Image src={`https://${env.NEXT_PUBLIC_S3_BUCKET_NAME}.t3.storage.dev/${course.fileKey}`} alt="Course Thumbnail Image" fill priority className="object-cover" />
                ...
                <div className="mt-8 space-y-6">
                    ...
                    {/*  level and category and duration */}
            ...
            {/* ENROLLEMENT CARD ON RIGHT SIDE */}
                    ...
                    <Card className="py-0">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <span className="text-2xl font-bold text-primary">{ new Intl.NumberFormat("de-DE", {style : "currency", currency: "EUR",}).format(course.price) }</span>
                            </div>
                            ...
                            <div className="mb-6 space-y-3 rounded-lg bg-muted p-4">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium">Difficutly Level</p>
