import { PublicCourseType } from "@/app/dataAcclyr/course/get-all-courses";
    ...
    return ( 
        <Card className="group relative py-0 gap-0">
            ...
            <CardContent className="p-4">
                ...
                {/* Button Learn more */}
                <Link href={`/courses/${data.slug}`} className={buttonVariants({className:"w-full mt-4"})}>Explore Now</Link>
            </CardContent>
        </Card>
    )
}
